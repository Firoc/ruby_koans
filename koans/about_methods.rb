...
class AboutMethods < Neo::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    # wrong number of arguments = Argument Error
  ...
  def test_calling_methods_in_same_class_with_explicit_receiver
    assert_equal 12, self.my_method_in_the_same_class(3,4) # can use self. also 
  end
  ...
  def test_calling_private_methods_in_other_objects
    rover = Dog.new
    assert_raise(NoMethodError) do # Can't call private method so nomethoderror
      rover.tail
    end
  end
end
