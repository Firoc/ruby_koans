...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # Probably to instantiate it, you need the 1 argument - might not be able to take more /less arguments
  end
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    assert_equal '"STRING"', "STRING".inspect #interesting that it does '"string"'
  end
