...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject starts off by taking the value that you put in (like 0 or 1 above)
    # and also a block. The block tells the operation of what to do with the values
    # inside the array. Here, it's taking 0, and adding the items into 0, like
    # (((0 + 2) + 3) + 4)
    # and then (((1*2)*3)*4)
  ...
  #   # code to read 'file'
  # 
  # I'm actually unsure why the File.open(filename) do |file| is better...
