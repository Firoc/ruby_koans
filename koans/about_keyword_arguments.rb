...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments
    ...
    assert_equal [1, 'two'], method_with_keyword_arguments # think of it as getting the values there
    assert_equal ['one', 'two'], method_with_keyword_arguments(one: 'one') # converting one: and two: to strings
    assert_equal [1, 2], method_with_keyword_arguments(two: 2) # converting 'two' to 2
  end
