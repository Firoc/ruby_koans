...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_failed_match_returns_nil
    assert_equal nil, "some matching content"[/missing/] # returns nil if missing
  end
  ...
  def test_question_mark_means_optional
    ...
    assert_equal "a", "abbcccddddeeeee"[/az?/] #no z in the string
  end

  def test_plus_means_one_or_more
    assert_equal "bccc", "abbcccddddeeeee"[/bc+/] #get all the c's bc c+
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? - never
  end
  ...
  # character class moves sequentially while alternation backtracks between
  # the alternation. this makes the alternation slower than the character class
